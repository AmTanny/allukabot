...
@run_async
def sgban(bot: Bot, update: Update, args: List[str]):
    message = update.effective_message  # type: Optional[Message]
...
@run_async
def sungban(bot: Bot, update: Update, args: List[str]):
    message = update.effective_message  # type: Optional[Message]
...
SGBAN_HANDLER = CommandHandler("sgban", sgban, pass_args=True,
                              filters=CustomFilters.sudo_filter | CustomFilters.support_filter)
UNGBAN_HANDLER = CommandHandler("ungban", ungban, pass_args=True,
                                filters=CustomFilters.sudo_filter | CustomFilters.support_filter)
SUNGBAN_HANDLER = CommandHandler("sungban", sungban, pass_args=True,
                                filters=CustomFilters.sudo_filter | CustomFilters.support_filter)
...
dispatcher.add_handler(SGBAN_HANDLER)
dispatcher.add_handler(UNGBAN_HANDLER)
dispatcher.add_handler(SUNGBAN_HANDLER)
