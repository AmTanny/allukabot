...
def get_user_list(config, key):
    with open('{}/alluka/{}'.format(os.getcwd(), config), 'r') as json_file:
...
class Config(object):
    ...
    SHIZUKU = [516449930]
    SILVA = [331863490]
    GON = [123456789] #NOONEISHERE
    ILLUMI_ZOLDYCK = [854853029]
    LEORIO = [575737330]
    BISCUIT = [586760757]
    CHROLLO = [806845434]
    KILLUA = [165822682] 
    MERUEM = [696086626] #SAHARSH
    KITE = [604968079] #NEEL

    #ZOLDYCK_FAMILY_STICKERS
